...
type DemoKey = 'actionState' | 'formStatus' | 'optimistic';

const ACCENT: Record<DemoKey, string> = {
    actionState: 'border-sky-500/30 bg-sky-500/10 text-sky-300',
    formStatus: 'border-violet-500/30 bg-violet-500/10 text-violet-300',
    optimistic: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-300',
};
