'use client';
// =============================================================================
// app/lessons/auth-setup/_components/github-button.tsx
// LAB 3 — GitHub OAuth sign-in via Server Action.
// -----------------------------------------------------------------------------
// 🧠 The `configured` flag is decided server-side (page.tsx checks
// process.env.AUTH_GITHUB_ID/SECRET). We don't expose the secret to the
// client — only the boolean "is it configured?".
// =============================================================================

import { useTransition } from 'react';
import { useLang } from '../../_components/lang-provider';
import { githubSignInAction } from '../_lib/actions';
...
export default function GitHubButton({
    ...
    const lang = useLang();
    const labels = content[lang].labs.github;
