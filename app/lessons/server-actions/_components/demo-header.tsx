...
type DemoKey = 'form' | 'programmatic' | 'revalidate';

const ACCENT: Record<DemoKey, string> = {
    form: 'border-sky-500/30 bg-sky-500/10 text-sky-300',
    programmatic: 'border-violet-500/30 bg-violet-500/10 text-violet-300',
    revalidate: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-300',
};
