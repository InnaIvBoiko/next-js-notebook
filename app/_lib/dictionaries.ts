...
type Dictionary = {
  ...
  modules: {
    ...
    title: string;
    description: string;
    lessons: { slug: string; label: string; status: "done" | "next" | "locked" }[];
  }[];
  footer: string;
};
  ...
  modules: [
    {
      id: "M1",
      title: "Architettura",
      description: "Le fondamenta dell'App Router: rendering, routing, layouts.",
      lessons: [
        { slug: "server-vs-client", label: "Server vs Client", status: "done" },
        { slug: "routing-basics", label: "Routing & Layouts", status: "next" },
        { slug: "dynamic-routes/[id]", label: "Rotte dinamiche", status: "locked" },
        { slug: "loading-and-errors", label: "Loading & Errors", status: "locked" },
      ],
    },
    {
      id: "M2",
      title: "Data Fetching & Cache",
      description: "Fetch lato server, caching, Server Actions, stato di mutazione.",
      lessons: [
        { slug: "server-fetching", label: "Server Fetching", status: "locked" },
        { slug: "caching", label: "Caching", status: "locked" },
        { slug: "server-actions", label: "Server Actions", status: "locked" },
        { slug: "action-pending", label: "useFormStatus", status: "locked" },
      ],
    },
    {
      id: "M3",
      ...
      lessons: [
        { slug: "context-provider", label: "Context Provider", status: "locked" },
        { slug: "zustand-store", label: "Zustand Store", status: "locked" },
        { slug: "tanstack-query", label: "TanStack Query", status: "locked" },
      ],
    },
    {
      id: "M4",
      ...
      lessons: [
        ...
        { slug: "database-orm", label: "Database & ORM", status: "locked" },
        { slug: "auth-setup", label: "Auth.js", status: "locked" },
        { slug: "middleware-logic", label: "Middleware", status: "locked" },
      ],
    },
    {
      id: "M5",
      title: "Performance & Sicurezza",
      description: "Ottimizzazione, SEO, sicurezza e deploy in produzione.",
      lessons: [
        { slug: "optimization-media", label: "Immagini & Font", status: "locked" },
        { slug: "seo-metadata", label: "SEO & Metadata", status: "locked" },
        { slug: "security-env", label: "Variabili & Sicurezza", status: "locked" },
        { slug: "advanced-routing", label: "Routing avanzato", status: "locked" },
  ...
  modules: [
    {
      id: "M1",
      title: "Architecture",
      description: "Foundations of the App Router: rendering, routing, layouts.",
      lessons: [
        { slug: "server-vs-client", label: "Server vs Client", status: "done" },
        { slug: "routing-basics", label: "Routing & Layouts", status: "next" },
        { slug: "dynamic-routes/[id]", label: "Dynamic Routes", status: "locked" },
        { slug: "loading-and-errors", label: "Loading & Errors", status: "locked" },
      ],
    },
    {
      id: "M2",
      title: "Data Fetching & Cache",
      description: "Server fetching, caching, Server Actions, mutation state.",
      lessons: [
        { slug: "server-fetching", label: "Server Fetching", status: "locked" },
        { slug: "caching", label: "Caching", status: "locked" },
        { slug: "server-actions", label: "Server Actions", status: "locked" },
    ...
    },
    {
      ...
      lessons: [
        { slug: "optimization-media", label: "Images & Fonts", status: "locked" },
        { slug: "seo-metadata", label: "SEO & Metadata", status: "locked" },
        { slug: "security-env", label: "Env & Security", status: "locked" },
        { slug: "advanced-routing", label: "Advanced Routing", status: "locked" },
        { slug: "deploy-ready", label: "Deploy", status: "locked" },
      ],
    },
  ],
  ...
  modules: [
    {
      id: "M1",
      title: "Архітектура",
      description: "Основи App Router: рендеринг, маршрутизація, layouts.",
      lessons: [
        { slug: "server-vs-client", label: "Server vs Client", status: "done" },
        { slug: "routing-basics", label: "Routing & Layouts", status: "next" },
        { slug: "dynamic-routes/[id]", label: "Динамічні маршрути", status: "locked" },
        { slug: "loading-and-errors", label: "Loading & Errors", status: "locked" },
      ],
    },
    {
      ...
      description: "Server fetching, кешування, Server Actions, стан мутацій.",
      lessons: [
        { slug: "server-fetching", label: "Server Fetching", status: "locked" },
    ...
    },
    {
      ...
      lessons: [
        { slug: "optimization-media", label: "Зображення & Шрифти", status: "locked" },
        { slug: "seo-metadata", label: "SEO & Metadata", status: "locked" },
        { slug: "security-env", label: "Env & Безпека", status: "locked" },
        { slug: "advanced-routing", label: "Розширена маршрутизація", status: "locked" },
        { slug: "deploy-ready", label: "Deploy", status: "locked" },
      ],
    },
  ],
